...
const Motogen = () => {
  ...
  const [activeTab, setActiveTab] = useState<string>("211");
  const [loading, setLoading] = useState(true);

  const tabs = [
    { id: "211", name: "سه‌فاز بدنه آلومینیوم", icon: Zap, color: "from-[#1c4793] to-[#32a3db]", shadow: "shadow-[#32a3db]/30" },
    { id: "212", name: "سه‌فاز بدنه چدن", icon: Flame, color: "from-[#e21f25] to-[#ff4b4b]", shadow: "shadow-[#e21f25]/30" },
    { id: "213", name: "تک فاز رله ای", icon: Wind, color: "from-[#113d64] to-[#1c4793]", shadow: "shadow-[#113d64]/30" },
    { id: "214", name: "تک فاز خازنی", icon: Wind, color: "from-[#113d64] to-[#1c4793]", shadow: "shadow-[#113d64]/30" },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 relative">
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold text-[#113d64] tracking-tight mb-4">
            الکتروموتورهای <span className="text-transparent bg-clip-text bg-gradient-to-l from-[#1c4793] to-[#32a3db]">موتوژن</span>
          </h2>
